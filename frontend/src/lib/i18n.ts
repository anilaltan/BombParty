...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    landingSubline: 'In KelimeBombası, every second counts. Each turn you must type a word containing the displayed syllable — or the bomb goes off. Play live with friends, test your Turkish vocabulary, and be the last one standing.',
    ...
    landingFeatTitle: 'Why KelimeBombası?',
  ...
  tr: {
    ...
    landingSubline: "KelimeBombası'nda saniyeler sayılı. Her tur yeni bir heceyi yazmanız gerekiyor, yoksa bomba patlar. Arkadaşlarınızla canlı oynayın, Türkçe bilginizi test edin ve son kalan oyuncu kazansın.",
    ...
    landingFeatTitle: 'Neden KelimeBombası?',
